      ...
      >
        <div className="w-72 h-72 space-y-3 -rotate-[30deg] relative  md:ms-none ms-20">
          ...
          <div className="flex gap-3 translate-x-8">
            <motion.div
              ...
              className=" w-24 h-24 animate-pulse delay-0 rounded-2xl bg-green-500"
            ></motion.div>
            <motion.div
              initial={{ opacity: 0, y: "2vh" }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 0.25 }}
              className=" w-24 h-24 animate-pulse delay-200 rounded-full bg-indigo-500"
            ></motion.div>
          </div>
          <div className="flex gap-3 -translate-x-8">
            <motion.div
              ...
              className=" w-24 h-24 animate-pulse delay-500 rounded-2xl bg-indigo-500"
            ></motion.div>
            <motion.div
              initial={{ opacity: 0, y: "2vh" }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.7, delay: 0.55 }}
              className=" w-24 h-24 animate-pulse delay-700 rounded-full bg-green-500"
            ></motion.div>
          </div>
        ...
        <div className=" absolute bottom-2  lg:bottom-14 lg:-left-10 md:left-56">
          <a download="" href="/Munab-Resume.pdf" className="h-[1rem]">
            <button
              className="group relative bg-slate-900/[0.8] border border-indigo-500 text-white flex flex-col gap-2 overflow-hidden items-center justify-start w-full h-[2.7rem] text-sm antialiased p-3 font-semibold hover:scale-105 hover:border-green-500 transition-all duration-150 "
              style={{ borderRadius: "calc(0.5rem * 0.96)" }}
            >
              <span className="transition-all duration-200 group-hover:-translate-y-7">
                📢 Available for Work
              </span>
              <span className="transition-all duration-200 group-hover:-translate-y-7">
                📗 Download Resume
